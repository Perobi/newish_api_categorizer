...
# # Example usage
# # Ensure DATA_PATH points to your CSV file
# train_models(DATA_PATH)

# # Predict the hierarchy of a new product title
# product_title = "Example Product Title"
# predicted_category, predicted_sub_category, predicted_type = predict_hierarchy(product_title)
# print(f"Predicted Category: {predicted_category}, Sub-Category: {predicted_sub_category}, Type: {predicted_type}")
